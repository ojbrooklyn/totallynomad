...
const COMPARISON_ROWS: { feature: string; free: boolean; plus: boolean }[] = [
  ...
  { feature: 'Country comparison tool', free: true, plus: true },
  { feature: 'City guides (10 cities)', free: true, plus: true },
  { feature: 'Service directory', free: true, plus: true },
  ...
  { feature: 'Post-arrival setup guides', free: false, plus: true },
  { feature: 'Healthcare info', free: false, plus: true },
  { feature: 'Blog access', free: true, plus: true },
  { feature: 'Community access (Discord)', free: true, plus: true },
