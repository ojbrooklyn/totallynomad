...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FFFBEB] dark:bg-[#0C1222] text-[#1C1917] dark:text-[#F5F5F4] transition-colors duration-200">
      ...
      {/* ── Footer ── */}
      <footer className="bg-[#134E4A] dark:bg-[#0C1222] border-t border-[#0F766E] dark:border-[#2A3444]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-teal-100 dark:text-stone-400 leading-relaxed">
            ...
            {footerColumns.map((col) => (
              <div key={col.heading}>
                <h3 className="text-sm font-semibold text-white dark:text-stone-100 uppercase tracking-wider mb-4">
                  {col.heading}
                </h3>
                <ul className="space-y-2">
                  {col.links.map((link) => (
                    <li key={link.to}>
                      <Link
                        to={link.to}
                        className="text-sm text-teal-200 dark:text-stone-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-150"
                      >
                        {link.label}
                      </Link>
                    </li>
          ...
          {/* Bottom bar */}
          <div className="border-t border-teal-700 dark:border-[#2A3444] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-teal-300 dark:text-gray-500">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                aria-label="Twitter"
                className="text-teal-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-150"
              >
